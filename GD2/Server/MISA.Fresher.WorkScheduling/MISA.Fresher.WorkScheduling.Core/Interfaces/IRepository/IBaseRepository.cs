...
namespace MISA.Fresher.WorkScheduling.Core.Interfaces.IRepository
{
    public interface IBaseRepository<TEntity>
    {
        ...
        public Task<TEntity> GetById(Guid tEntityId);
        /// <summary>
        /// tạo mới
        /// Lê Duy Tuân 20/12/2021
        /// </summary>
        ...
        public Task<int> Insert(TEntity tEntity);
        /// <summary>
        /// sửa thông tin
        /// Lê Duy Tuân 20/12/2021
        /// </summary>
        ...
        /// <param name="tEntity"></param>
        /// <returns> số bản ghi ảnh hưởng</returns>
        public Task<int> Update(Guid tEntityId, TEntity tEntity);
        /// <summary>
        /// xóa theo id
        /// Lê Duy Tuân 20/12/2021
        /// </summary>
        /// <param name="tEntityId"></param>
        /// <returns> số bản ghi ảnh hưởng</returns>
        public Task<int> Delete(string tEntityId);
    }
}
